...
public class WoodBucketItem extends Item implements FluidModificationItem {
    public final Fluid fluid;
    private EntityType<?> entityType = null;

    public WoodBucketItem(Fluid fluid, Settings settings, EntityType<?> entityType) {
        super(settings);
        this.fluid = fluid;
        if (entityType != null){
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        BlockHitResult blockHitResult = net.minecraft.item.BucketItem.raycast(world, user, this.fluid == Fluids.EMPTY ? RaycastContext.FluidHandling.SOURCE_ONLY : RaycastContext.FluidHandling.NONE);
        ...
        if (blockHitResult.getType() == HitResult.Type.BLOCK) {
            ...
            if (this.fluid == Fluids.EMPTY && this.entityType == null) {
            ...
            if (this.placeFluid(user, world, blockPos3, blockHitResult)) {
                ...
                user.incrementStat(Stats.USED.getOrCreateStat(this));
                return TypedActionResult.success(net.minecraft.item.BucketItem.getEmptiedStack(itemStack, user), world.isClient());
            }
            return TypedActionResult.fail(itemStack);
        }
        return TypedActionResult.pass(itemStack);
