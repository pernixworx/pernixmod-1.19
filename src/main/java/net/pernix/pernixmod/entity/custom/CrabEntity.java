...
public class CrabEntity extends AnimalEntity implements IAnimatable, DryBucketable {
    public int eggLayTime;

    private static final TrackedData<Boolean> PLAYING_DEAD = DataTracker.registerData(CrabEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient && this.isAlive() && --this.eggLayTime <= 0) {
            ...
            this.dropItem(ModItems.RAW_CHITIN);
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(3, new TemptGoal(this, 1.0, Ingredient.ofItems(Items.COD, Items.COD_BUCKET), false));
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if (event.isMoving() || this.isNavigating() || this.getVelocity().getX() > 0
        || this.getVelocity().getY() > 0 || this.getVelocity().getZ() > 0) {
